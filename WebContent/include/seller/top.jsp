		...
		<div class="offcanvas__option">
			<div class="offcanvas__links">
				...
				<c:if test="${not empty sessionScope.SEQ_SLL}">
					<a href="/seller/login/logout.web">Logout</a>
				</c:if>
			</div>
		</div>
				...
				<div class="col-lg-6 col-md-5">
					<div class="header__top__right">
						<div class="header__top__links">
							<c:if test="${empty sessionScope.SEQ_SLL}">
								<a href="/seller/login/loginForm.web">Login</a>
							</c:if>
							<c:if test="${not empty sessionScope.SEQ_SLL}">
								<a href="/seller/mypage/" title="${sessionScope.SLL_NM}">MYPAGE</a>
								<a href="/seller/login/logout.web">LOGOUT</a>
							</c:if>
						</div>
		...
		<div class="row">
			<div class="col-lg-3 col-md-3">
				<div class="header__logo" style="padding:0">
					<a href="/seller/mypage/"><img src="/img/logo/black.png" alt="" style="height:84px;"></a>
				</div>
			</div>
