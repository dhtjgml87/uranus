...
<%@ page info="/seller/center/board/quest/writeForm.jsp" %>
<!DOCTYPE html>
<html lang="kr">
<head>
...
<script>
	...
	function cancelFileUpload(index) {
		$("#files_" + index).val(""); // 파일 입력 초기화
		$("#previewDtl .dtlImg_" + index).attr("src", ""); // 미리보기 이미지 초기화
		$(".dtlImg > div > div").hide(); // 미리보기 영역 숨김
	}
	...
	function writeProc(value) {
		...
		*/
		...
		$("#frmMain").attr("action", "/seller/center/board/writeProc.web");
		$("#frmMain").submit();
	}
		...
		<article class="saleWrite">
			...
			<form id="frmMain" name="frmMain" method="POST" enctype="multipart/form-data">
				...
				<div style="white-space: nowrap; text-align: center;">
					<input class="styled-button" type="button" value="등록" style="width:100px; display: inline-block; margin-right: 10px;" onclick="javascript:writeProc(6)" />
