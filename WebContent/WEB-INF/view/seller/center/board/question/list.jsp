...
<%@ page info="/seller/center/board/question/list.jsp" %>
...
<style>
	...
	input[type=button] {display:block;width:120px;height:50px;margin:20px auto 0;line-height:50px;background:black;color:white;border-radius:10px;border:none;}
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<div>
						<input class="styled-button" type="button" value="문의하기" style="width:100px" onclick="window.location.href='/seller/center/board/writeForm.web?cd_bbs_type=6';" />
					</div>
				</div>
			</div>
			<div class="row">
