...
<%@ page info="/front/member/fine/id.jsp" %>
<!DOCTYPE html>
<html lang="kr">
<head>
	...
	<script>
		function findId() {
			...
			var data = {mbr_nm: $("#mbr_nm").val(), phone: $("#phone").val()};
			
			$.ajax({
				method: 'POST',
				url: '/front/member/findIdProc.json',
				contentType: 'application/json',
				dataType: 'json', // 응답 데이터를 JSON으로 처리
				data: JSON.stringify(data),
				success:function(res) {
					if (res)
						alert("고객님의 전화번호로 문자를 보냈으니 확인해주세요");
					else
...
<body>
	...
	<section class="content">
		...
		<article class="findId">
			...
			<div>
				<a href="/front/member/findPasswd.web">비밀번호 찾기</a>
