...
<%@ page info="/front/center/board/question/view.jsp" %>
					...
					<div class="shopping__cart__table">
						...
						<div style="white-space: nowrap;text-align:center">
							<c:if test="${boardDto.seq_reply == 0}">
								<input class="styled-button" type="button" value="수정" style="width:100px; display: inline-block; margin-right: 10px;" onclick="javascript:modifyForm(3);" />
								<input class="styled-button" type="button" value="삭제" style="width:100px; display: inline-block;" onclick="javascript:remove(3);" />
							</c:if>
						</div> 
					<c:if test="${boardDto.seq_reply > 0}">
						<div>
