...
<%@ page info="/backoffice/view/backoffice/center/board/notice/modifyForm.jsp"%>
						...
						<div class="card">
							<div class="card-content">
								...
								<div style="text-align:right">
									<input class="waves-effect waves-light btn" type="button" value="등록" style="width:100px" onclick="javascript:modifyProc(1);" />
