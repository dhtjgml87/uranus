...
<%@ page info="/backoffice/view/backoffice/center/board/notice/list.jsp"%>
				...
				<div class="col-md-6" style="width:100%">
					<div class="card" >
						<div class="card-action">
												...
												<c:otherwise>
													<c:forEach items="${list}" var="item">
														<tr>
															...
															<td style=" font-weight: bold;color: gray; font-size: 13px; text-align: center; width: 12%">
																${item.dt_reg}
															</td >
															<td style=" font-weight: bold;color: gray; font-size: 13px; text-align: center; width: 9%">
																${item.readed}
															</td>
														</tr>
													</c:forEach>
							...
							<input class="waves-effect waves-light btn" type="button" value="글 등록" style="width:100px" onclick="window.location.href='/console/center/board/writeForm.web?cd_bbs_type=1';" />
							</div>
