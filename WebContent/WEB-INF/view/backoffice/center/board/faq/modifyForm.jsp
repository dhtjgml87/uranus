...
<%@ page info="/backoffice/view/backoffice/center/board/faq/modifyForm.jsp""%>
	...
	<div id="wrapper">
		...
		<form id="frmMain" name="frmMain" method="POST" enctype="multipart/form-data">
			...
			<div class="col-md-6" style="width:80%">
				<div class="card" >
					<div class="card-action" style="padding-top: 60px">
						<div class="card-content" style="font-weight: normal;">
							<div class="table-responsive" style="width:125%;">
								<div class="write" style="width:80%">
								<div class="sle_nm">
									<p>제목</p>
									<input value="${boardDto.title}" type="text" id="title" name="title" style="width: 75%;" required />
					...
					<input type="button" value="등록" style="width:100px" onclick="javascript:modifyProc(${boardDto.cd_bbs_type});" />
					<input type="button" value="취소" style="width:100px" onclick="javascript:history.back();"/>
				</div>
			</div>
			</div>
			</div>
