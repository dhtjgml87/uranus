...
<body>
	...
	<div id="page-wrapper" >
		<div class="header">
			<h1 class="page-header">고객문의 답변</h1>
		</div>
						...
						<div class="card">
							<div class="card-content">
								...
								<div style="text-align:right">
									<input class="waves-effect waves-light btn" type="button" value="등록" style="width:100px" onclick="javascript:writeProc(${boardDto.seq_bbs});" />
