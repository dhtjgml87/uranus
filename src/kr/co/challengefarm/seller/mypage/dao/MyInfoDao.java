 ...
 */
package kr.co.challengefarm.seller.mypage.dao;
 ...
 * <p>IMPORTANT:</p>
 */
@Repository("kr.co.challengefarm.seller.mypage.dao.MyInfoDao")
public class MyInfoDao extends BaseDao {
	
	@Autowired // @Inject 대신 @Autowired 사용
	private SqlSession sqlSessionSeller;
	
	public MyInfoDto select(MyInfoDto myInfoDto) {
		return sqlSessionSeller.selectOne("kr.co.challengefarm.seller.mybatis.mypage.MyInfo.select", myInfoDto);
	}
