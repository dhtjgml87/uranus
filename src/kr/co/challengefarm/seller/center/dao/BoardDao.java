 ...
 */
package kr.co.challengefarm.seller.center.dao;
 ...
 * <p>IMPORTANT:</p>
 */
@Repository("kr.co.challengefarm.seller.center.dao.BoardDao")
public class BoardDao extends BaseDao {
	...
	public BoardDto selectReply(BoardDto boardDto) {
		return sqlSessionSeller.selectOne("kr.co.challengefarm.seller.mybatis.center.Board.selectReply", boardDto);
	}
	
	public int count(PagingDto pagingDto) {
		return sqlSessionSeller.selectOne("kr.co.challengefarm.seller.mybatis.center.Board.count", pagingDto);
	}
	...
	public int delete(BoardDto boardDto) {
		return sqlSessionSeller.delete("kr.co.challengefarm.seller.mybatis.center.Board.delete", boardDto);
	}
	...
	public int insert(BoardDto boardDto) {
		return sqlSessionSeller.insert("kr.co.challengefarm.seller.mybatis.center.Board.insert", boardDto);
	}
	...
	public int deleteFlag(BoardDto boardDto) {
		return sqlSessionSeller.update("kr.co.challengefarm.seller.mybatis.center.Board.deleteFlag", boardDto);
	}
	...
	public int deleteFile(BoardDto boardDto) {
		return sqlSessionSeller.update("kr.co.challengefarm.seller.mybatis.center.Board.deleteFile", boardDto);
	}
	...
	public int update(BoardDto boardDto) {
		return sqlSessionSeller.update("kr.co.challengefarm.seller.mybatis.center.Board.update", boardDto);
	}
	...
	public BoardDto select(BoardDto boardDto) {
		...
		return sqlSessionSeller.selectOne("kr.co.challengefarm.seller.mybatis.center.Board.select", boardDto);
	...
	public List<BoardFileDto> selectFile(BoardFileDto boardFileDto) {
			...
			return sqlSessionSeller.selectList("kr.co.challengefarm.seller.mybatis.center.Board.selectFile", boardFileDto);
	}
	
	
	public List<BoardDto> list(PagingDto pagingDto) {
		
		return sqlSessionSeller.selectList("kr.co.challengefarm.seller.mybatis.center.Board.list", pagingDto);
	...
	public int readed(BoardDto boardDto) {
		return sqlSessionSeller.update("kr.co.challengefarm.seller.mybatis.center.Board.readed", boardDto);
	}
	
	public int sequence() {
		return sqlSessionSeller.selectOne("kr.co.challengefarm.seller.mybatis.center.Board.sequence");
	}
