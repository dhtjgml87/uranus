 ...
 *				: [20240624110234][pluto@himedia.co.kr][CREATE: Initial Release]
 */
package kr.co.challengefarm.common.aop;
...
public class CommonAop {
	 ...
	 * </p>
	 */
	@Pointcut("execution(* kr.co.challengefarm..*Web.*(..)) || execution(* kr.co.challengefarm..*Api.*(..))")
