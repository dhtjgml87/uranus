 ...
 *				: [20240813155802][pluto@himedia.co.kr][CREATE: Initial Release]
 */
 ...
 * <p>IMPORTANT:</p>
 */
@Repository("kr.co.challengefarm.front.member.dao.StatisticMemberDao")
public class StatisticMemberDao extends BaseDao {
	
	public int insert(StatisticMemberDto statisticMemberDto) {
		return sqlSessionFront.insert("kr.co.challengefarm.front.mybatis.member.StatisticMember.insert", statisticMemberDto); 
	}
}
