 ...
 */
package kr.co.challengefarm.front.interfaces.component;
 ...
 * <p>IMPORTANT:</p>
 */
@Component(" kr.co.challengefarm.front.interfaces.component.PayupCmpn")
public class PayupCmpn {
	...
	public Map<String,Object> JsonApi(HttpServletRequest requests, String url, Map<String, String> map, String Authorization) {
		...
		if (kr.co.challengefarm.util.servlet.Request.isDevice(requests, "mobile")) {
