 ...
 */
package kr.co.challengefarm.backoffice.center.dao;
...
import kr.co.challengefarm.backoffice.center.dto.BoardFileDto;
 ...
 * <p>IMPORTANT:</p>
 */
@Repository("kr.co.challengefarm.backoffice.center.dao.BoardDao")
public class BoardDao extends BaseDao {
	...
	public int replied(BoardDto boardDto) {
		return sqlSessionBackoffice.insert("kr.co.challengefarm.backoffice.mybatis.center.Board.replied", boardDto);
	}
	...
	public BoardDto selectQuestion(BoardDto boardDto) {
		...
		return sqlSessionBackoffice.selectOne("kr.co.challengefarm.backoffice.mybatis.center.Board.selectQuestion", boardDto);
	}
	...
	public BoardDto selectReply(BoardDto boardDto) {
		return sqlSessionBackoffice.selectOne("kr.co.challengefarm.backoffice.mybatis.center.Board.selectReply", boardDto);
	}
	
	public int count(PagingDto pagingDto) {
		return sqlSessionBackoffice.selectOne("kr.co.challengefarm.backoffice.mybatis.center.Board.count", pagingDto);
	}
	...
	public int delete(BoardDto boardDto) {
		return sqlSessionBackoffice.delete("kr.co.challengefarm.backoffice.mybatis.center.Board.delete", boardDto);
	}
	...
	public int insert(BoardDto boardDto) {
		return sqlSessionBackoffice.insert("kr.co.challengefarm.backoffice.mybatis.center.Board.insert", boardDto);
	}
	...
	public int deleteFlag(BoardDto boardDto) {
		return sqlSessionBackoffice.update("kr.co.challengefarm.backoffice.mybatis.center.Board.deleteFlag", boardDto);
	}
	...
	public int update(BoardDto boardDto) {
		return sqlSessionBackoffice.update("kr.co.challengefarm.backoffice.mybatis.center.Board.update", boardDto);
	}
	...
	public BoardDto select(BoardDto boardDto) {
		...
		return sqlSessionBackoffice.selectOne("kr.co.challengefarm.backoffice.mybatis.center.Board.select", boardDto);
	...
	public List<BoardFileDto> selectFile(BoardFileDto boardFileDto) {
			...
			return sqlSessionBackoffice.selectList("kr.co.challengefarm.backoffice.mybatis.center.Board.selectFile", boardFileDto);
	}
	
	public List<BoardDto> list(PagingDto pagingDto) {
		
		return sqlSessionBackoffice.selectList("kr.co.challengefarm.backoffice.mybatis.center.Board.list", pagingDto);
	...
	public int readed(BoardDto boardDto) {
		return sqlSessionBackoffice.update("kr.co.challengefarm.backoffice.mybatis.center.Board.readed", boardDto);
	}
	
	public int sequence() {
		return sqlSessionBackoffice.selectOne("kr.co.challengefarm.backoffice.mybatis.center.Board.sequence");
	}
